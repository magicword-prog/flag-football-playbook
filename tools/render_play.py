...
PLAYS['b11'] = {
    ...
    'subtitle': 'Base formation — QB drops back, Green comes across in front of the QB and takes a short forward shovel pass',
    'ball': [(0, 'PRESNAP'), (0.45, 'QB'), (2.2, ('pass', 'QB', 'G', 2.5)), (2.5, 'G')],
    'players': [
        ('R', [(0, 235, 214), (0.6, 235, 214), (1.5, 215, 190), (5.0, 200, 100)]),
        ('G', [(0, 644, 214), (0.5, 644, 214), (1.3, 560, 262), (2.2, 445, 272), (2.5, 400, 272), (3.0, 330, 262), (3.5, 262, 214), (5.0, 262, 88)]),
        ('C', [(0, 399, 214), (0.6, 399, 214), (5.0, 399, 120)]),
        ('B', [(0, 325, 345), (0.5, 325, 345), (1.5, 315, 300), (2.5, 315, 235), (5.0, 325, 100)]),
        ('P', [(0, 514, 354), (0.5, 514, 354), (1.5, 560, 300), (2.5, 600, 240), (5.0, 610, 110)]),
        ('QB', [(0, 399, 252), (0.45, 399, 252), (1.2, 399, 300), (2.5, 399, 300), (5.0, 395, 302)]),
    ],
}
...
PLAYS['b9'] = {
    ...
    'ball': [(0, 'PRESNAP'), (0.55, 'QB'), (1.8, 'R'), (3.6, 'G')],
    'dur': 6.0,
    # Red and Green both 270px off center (Red 129, Green 669); Green a half-step off the LOS (y=250)
    # so she comes back clear behind Red for the handoff. Blue/Purple swing flat to the sidelines.
    'players': [
        ('R', [(0.0, 129, 215), (0.55, 129, 215), (0.7, 140, 232), (1.1, 230, 270), (1.8, 395, 284), (3.6, 600, 284), (5.3, 740, 280), (6.0, 740, 280)]),
        ('G', [(0.0, 669, 250), (2.6, 669, 250), (3.1, 640, 278), (3.6, 600, 288), (3.9, 540, 312), (4.2, 450, 340), (4.5, 380, 350), (4.8, 300, 340), (5.1, 220, 315), (5.3, 200, 300), (6.0, 200, 91)]),
        ('C', [(0.0, 397, 214), (0.5, 397, 214), (5.0, 397, 102), (6.0, 392, 99)]),
        ('P', [(0.0, 475, 330), (1.8, 475, 330), (2.6, 570, 334), (3.6, 700, 336), (5.0, 800, 336), (6.0, 830, 336)]),
        ('B', [(0.0, 325, 330), (1.8, 325, 330), (2.6, 230, 334), (3.6, 120, 336), (5.0, 60, 336), (6.0, 50, 336)]),
        ('QB', [(0.0, 399, 253), (0.55, 395, 254), (1.8, 399, 251), (6.0, 402, 254)]),
    ],
}
...
PLAYS['b10'] = {
    ...
    'ball': [(0, 'PRESNAP'), (0.55, 'QB'), (1.8, 'R')],
    'dur': 6.0,
    'players': [
        ('R', [(0.0, 129, 215), (0.55, 129, 215), (0.7, 140, 232), (1.1, 230, 270), (1.8, 395, 284), (3.6, 600, 284), (4.1, 660, 250), (4.5, 690, 205), (4.9, 700, 150), (5.4, 705, 88), (6.0, 705, 88)]),
        ('G', [(0.0, 669, 250), (2.6, 669, 250), (3.1, 640, 278), (3.6, 600, 288), (3.9, 540, 312), (4.2, 450, 340), (4.5, 380, 350), (4.8, 300, 340), (5.1, 220, 315), (5.3, 200, 300), (6.0, 200, 91)]),
        ('C', [(0.0, 397, 214), (0.5, 397, 214), (5.0, 397, 102), (6.0, 392, 99)]),
        ('P', [(0.0, 475, 330), (1.8, 475, 330), (2.6, 570, 334), (3.6, 700, 336), (5.0, 800, 336), (6.0, 830, 336)]),
        ('B', [(0.0, 325, 330), (1.8, 325, 330), (2.6, 230, 334), (3.6, 120, 336), (5.0, 60, 336), (6.0, 50, 336)]),
        ('QB', [(0.0, 399, 253), (0.55, 395, 254), (1.8, 399, 251), (6.0, 400, 254)]),
    ],
}
...
PLAYS['b14'] = {
    'title': 'Play 14: Fake End-Around Green, Pass to Center',
    'subtitle': 'Same end-around look — QB fakes to Green, Center runs 8 yards and turns around for the pass; backs stay home',
    'ball': [(0, 'PRESNAP'), (0.45, 'QB'), (2.9, ('pass', 'QB', 'C', 3.3)), (3.3, 'C')],
    'los_y': EA_LOS, 'dur': 6.0,
    'players': [
        ...
        ('B', [(0, 325, 421), (6.0, 325, 421)]),
        ('P', [(0, 514, 430), (6.0, 514, 430)]),
        ('QB', [(0, 399, 328), (0.45, 399, 328), (1.0, 399, 366), (1.6, 399, 366), (2.2, 405, 372), (6.0, 405, 372)]),
    ],
}
