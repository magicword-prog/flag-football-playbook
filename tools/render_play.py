...
PLAYS[11] = {
    ...
    'subtitle': 'Purple and Blue cross behind QB — fake to Blue going left, handoff to Purple going right',
    ...
    'players': [
        ...
        ('B', [(0, 514, 354), (0.4, 514, 354), (1.7, 415, 336), (2.6, 310, 322), (3.6, 262, 292), (5.0, 250, 268)]),
        ('P', [(0, 284, 354), (0.4, 284, 354), (1.5, 408, 308), (2.3, 535, 292), (3.0, 570, 214), (5.0, 592, 104)]),
        ('QB', [(0, 399, 252), (0.45, 399, 252), (1.0, 399, 288), (1.8, 399, 288), (2.6, 378, 300), (5.0, 372, 302)]),
    ],
}
...
PLAYS[12] = {
    ...
    'players': [
        ('R', [(0, 284, 214), (0.4, 284, 214), (1.1, 248, 272), (2.0, 288, 324), (2.5, 332, 332), (3.4, 500, 330), (4.0, 640, 306), (4.5, 700, 214), (5.0, 722, 122)]),
        ('G', [(0, 644, 214), (0.5, 644, 214), (1.6, 644, 148), (2.7, 562, 142), (4.0, 540, 140), (5.0, 535, 140)]),
        ('C', [(0, 399, 214), (0.7, 399, 214), (5.0, 372, 126)]),
        ('B', [(0, 514, 354), (0.4, 514, 354), (1.5, 428, 330), (2.5, 332, 330), (3.5, 252, 300), (5.0, 240, 278)]),
        ('P', [(0, 284, 354), (0.4, 284, 354), (1.2, 402, 314), (2.2, 520, 300), (3.2, 560, 282), (5.0, 572, 272)]),
